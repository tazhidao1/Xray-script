...
function download_github_files() {
  ...
  local github_api="${2:-https://api.github.com/repos/tazhidao1/Xray-script/contents}"
...
function check_xray_script_dependencies() {
  local -a dependencies=(
    "ssl.sh|https://api.github.com/repos/tazhidao1/Xray-script/contents/ssl.sh"
    "nginx.sh|https://api.github.com/repos/tazhidao1/Xray-script/contents/nginx.sh"
    "docker.sh|https://api.github.com/repos/tazhidao1/Xray-script/contents/docker.sh"
  )
  ...
  for dep in "${dependencies[@]}"; do
    ...
    if [[ "$remote_size" != "$local_size" ]]; then
      ...
      if wget -q --show-progress -O "$tmp_file" "https://raw.githubusercontent.com/tazhidao1/Xray-script/main/${filename}"; then
...
function check_xray_script_version() {
  ...
  local url="https://api.github.com/repos/tazhidao1/Xray-script/contents/xhttp.sh"
  ...
  if [[ "${local_size}" != "${remote_size}" ]]; then
    ...
    *)
      ...
      # 下载新脚本并检查是否成功
      if ! wget --no-check-certificate -O "$tmp_script" "https://raw.githubusercontent.com/tazhidao1/Xray-script/main/xhttp.sh"; then
        rm -rf "${tmp_script}"
        _warn "新脚本下载失败，请手动更新脚本"
        _warn "echo 'wget --no-check-certificate -O ${HOME}/Xray-script.sh https://raw.githubusercontent.com/tazhidao1/Xray-script/main/xhttp.sh && bash ${HOME}/Xray-script.sh'"
        exit 1
      fi
...
function enable_cron() {
  if ! [[ -f /usr/local/xray-script/update-dat.sh ]]; then
    wget --no-check-certificate -O /usr/local/xray-script/update-dat.sh https://raw.githubusercontent.com/tazhidao1/Xray-script/main/tool/update-dat.sh
...
function get_xtls_download_url() {
  local url="https://api.github.com/repos/tazhidao1/Xray-script/contents/XTLS"
...
function setup_nginx_config_data() {
  [[ -f /usr/local/nginx/conf/nginxconfig.txt ]] || {
    ...
    download_github_files '/usr/local/nginx/conf' 'https://api.github.com/repos/tazhidao1/Xray-script/contents/nginx/conf'
...
function setup_ssl() {
  stop_renew_ssl
  # 设置新域名对应的 nginx 配置文件
  wget --no-check-certificate -O /usr/local/nginx/conf/modules-enabled/stream.conf https://raw.githubusercontent.com/tazhidao1/Xray-script/main/nginx/conf/modules-enabled/stream.conf
  ...
  wget --no-check-certificate -O /usr/local/nginx/conf/sites-available/${reality_domain}.conf https://raw.githubusercontent.com/tazhidao1/Xray-script/main/nginx/conf/sites-available/example.com.conf
  ...
  [[ ${reality_domain} == ${cdn_domain} ]] || {
    wget --no-check-certificate -O /usr/local/nginx/conf/sites-available/${cdn_domain}.conf https://raw.githubusercontent.com/tazhidao1/Xray-script/main/nginx/conf/sites-available/example.com.conf
...
function view_xray_traffic() {
  [[ -f /usr/local/xray-script/traffic.sh ]] || wget --no-check-certificate -O /usr/local/xray-script/traffic.sh https://raw.githubusercontent.com/tazhidao1/Xray-script/main/tool/traffic.sh
...
function main_processes() {
  ...
  if ! [[ -d /usr/local/xray-script ]]; then
    ...
    wget --no-check-certificate -O /usr/local/xray-script/nginx.sh https://raw.githubusercontent.com/tazhidao1/Xray-script/main/nginx.sh
    wget --no-check-certificate -O /usr/local/xray-script/ssl.sh https://raw.githubusercontent.com/tazhidao1/Xray-script/main/ssl.sh
    wget --no-check-certificate -q -O /usr/local/xray-script/docker.sh https://raw.githubusercontent.com/tazhidao1/Xray-script/main/docker.sh
    wget --no-check-certificate -q -O /usr/local/xray-script/config.json https://raw.githubusercontent.com/tazhidao1/Xray-script/refs/heads/main/XTLS/config.json
    wget --no-check-certificate -q -O /usr/local/xray-script/serverNames.json https://raw.githubusercontent.com/tazhidao1/Xray-script/refs/heads/main/XTLS/serverNames.json
  fi
